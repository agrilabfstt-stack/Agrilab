...
<div class="max-w-2xl">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <form method="POST" action="{{ route('admin.users.update', $user) }}" x-data="userForm()">
            @csrf @method('PUT')
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <select name="role" x-model="role" required
                        ...
                        <option value="professor" {{ old('role', $user->role) === 'professor' ? 'selected' : '' }}>Professeur</option>
                ...
                <div x-show="role === 'student'" x-cloak>
                    ...
                    <select name="professor_id"
                        ...
                        <option value="{{ $prof->id }}" {{ old('professor_id', $user->professor_id) == $prof->id ? 'selected' : '' }}>
                            {{ $prof->name }}
                        </option>
                        @endforeach
                    </select>
