...
@section('title', $project->title . ' — Showcase Agrilab')

@section('content')
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10" x-data="{ lightboxUrl: '' }">

    {{-- Back link --}}
    <a href="{{ route('showcase.index') }}" class="inline-flex items-center gap-2 text-sm text-green-700 hover:text-green-800 mb-6 transition-colors">
            ...
            <div class="flex flex-col sm:flex-row sm:items-start gap-4 justify-between">
                <div class="flex-1 min-w-0">
                    <div class="flex flex-wrap items-center gap-3 mb-3">
                        ...
                        @endif
                        <span class="text-xs px-2.5 py-1 rounded-full bg-amber-100 text-amber-700 font-medium">⭐ Showcase</span>
                    </div>
                    <div class="flex flex-wrap gap-4 text-sm text-gray-500">
                        ...
                        <span class="flex items-center gap-1.5">
                            ...
                            Professeur : <span class="font-medium text-gray-900">{{ $project->creator->name ?? ($project->user->professor->name ?? '—') }}</span>
                        </span>
                        <span class="flex items-center gap-1.5">
